...
<div id="navbuttons">
    <div>
        <button><img className="column" src={set} style={{width: "100%"}} alt = "set"/></button>
    </div>

    <div>
        <button><img className="column" src={home2} style={{width: "100%", float: "right"}} alt = "set" /></button>
    </div>
    ...
    <div><Link to ='/transportation'><button><img src={bike} style={{marginRight: "5%", marginBottom: "-1%", width: "11%"}} alt = "bike"/> Transportation </button></Link></div>
